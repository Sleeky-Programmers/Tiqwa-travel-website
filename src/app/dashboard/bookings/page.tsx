	...
	return (
		<div className="dashboard-page space-y-6">
			<div className="dashboard-page-header">
				...
				<p className="dashboard-subtitle">View and manage your flight reservations</p>
			</div>
									...
									<div className="text-right">
										...
										<p
											className={`text-xs capitalize ${
												booking.status === 'confirmed' ? 'text-green-600' : booking.status === 'cancelled' ? 'text-red-600' : 'text-amber-600'
											}`}>
											{booking.status}
										</p>
									</div>
